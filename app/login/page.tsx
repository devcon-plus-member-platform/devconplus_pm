        ...
        <div>
          <div className="flex items-center gap-2.5 mb-12">
            <div className="w-8 h-8 rounded-lg bg-brand-600 flex items-center justify-center">
              <svg className="w-4.5 h-4.5 text-white w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.75} viewBox="0 0 24 24">
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500">
              Access the DEVCON+ project dashboard
            </p>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-2.5 mb-4 bg-white border border-gray-300 rounded-xl hover:bg-gray-50 hover:border-gray-400 disabled:opacity-60 transition-all duration-150 text-sm font-medium text-gray-700 shadow-sm"
          >
            {googleLoading ? (
          ...
          <div className="relative mb-4">
            ...
            <div className="relative flex justify-center">
              <span className="bg-gray-50 px-3 text-[11px] text-gray-400 font-medium uppercase tracking-wide">or</span>
            </div>
          </div>
